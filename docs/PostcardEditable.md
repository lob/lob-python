...
**_from** | **bool, date, datetime, dict, float, int, list, str, none_type** | Required if &#x60;to&#x60; address is international. Must either be an address ID or an inline object with correct address parameters. | [optional] 
