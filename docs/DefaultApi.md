...
import time
import lob_python
from lob_python.api import default_api
...
with lob_python.ApiClient(configuration) as api_client:
    ...
    try:
        # placeholder_no_call
        api_response = api_instance.placeholder_no_call()
        pprint(api_response)
    except lob_python.ApiException as e:
        print("Exception when calling DefaultApi->placeholder_no_call: %s\n" % e)
```
