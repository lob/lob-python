...
###########################################################
# TODO: Provide the following constants
# Your API Key, keep this secure
lob.api_key = 'test_fc26575412e92e22a926bc96c857f375f8b'

# Does the input file have headers in the first row?
IS_HEADER = True
...
with open(input_filename, 'r') as input, \
    ...
    print('Sending letters in %s mode.' % mode.upper())
    ...
    try:
        ...
        print('Error: %s' % str(e))
        print('Failed to create from_address. Aborting all sends.')
        sys.exit(1)
