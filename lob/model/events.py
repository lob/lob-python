...
class Events(ModelNormal):
    ...
    validations = {
        ('id',): {
            'regex': {
                'pattern': r'^evt_[a-zA-Z0-9_]+$',  # noqa: E501
            },
        },
    }
    ...
    def _from_openapi_data(cls, id, body, reference_id, event_type, date_created, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            object (str): Value is resource type.. defaults to "event", must be one of ["event", ]  # noqa: E501
        ...
        object = kwargs.get('object', "event")
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, body, reference_id, event_type, date_created, *args, **kwargs):  # noqa: E501
        """Events - a model defined in OpenAPI
