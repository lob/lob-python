...
class LocationAnalysis(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, latitude, longitude, distance, *args, **kwargs):  # noqa: E501
        """LocationAnalysis - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, latitude, longitude, distance, *args, **kwargs):  # noqa: E501
        """LocationAnalysis - a model defined in OpenAPI
