...
class GeocodeComponents(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, zip_code, zip_code_plus_4, *args, **kwargs):  # noqa: E501
        """GeocodeComponents - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, zip_code, zip_code_plus_4, *args, **kwargs):  # noqa: E501
        """GeocodeComponents - a model defined in OpenAPI
