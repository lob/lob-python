...
class Suggestions(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, primary_line, city, state, zip_code, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, primary_line, city, state, zip_code, *args, **kwargs):  # noqa: E501
        """Suggestions - a model defined in OpenAPI
