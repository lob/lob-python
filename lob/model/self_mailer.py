...
class SelfMailer(ModelNormal):
    ...
    def _from_openapi_data(cls, id, to, url, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            size (SelfMailerSize, type(None)): [optional] # noqa: E501
            ...
            outside_template_id (str, type(None)): The unique ID of the HTML template used for the outside of the self mailer.. [optional] # noqa: E501
            inside_template_id (str, type(None)): The unique ID of the HTML template used for the inside of the self mailer.. [optional] # noqa: E501
            outside_template_version_id (str, type(None)): The unique ID of the specific version of the HTML template used for the outside of the self mailer.. [optional] # noqa: E501
            inside_template_version_id (str, type(None)): The unique ID of the specific version of the HTML template used for the inside of the self mailer.. [optional] # noqa: E501
            object (str, type(None)): Value is resource type.. [optional] if omitted the server will use the default value of "self_mailer" # noqa: E501
