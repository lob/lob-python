...
globals()['EngineHtml'] = EngineHtml
globals()['ResourceDescription'] = ResourceDescription
globals()['TemplateHtml'] = TemplateHtml
globals()['VrsnId'] = VrsnId


class TemplateVersion(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'engine': (EngineHtml, type(None)),  # noqa: E501
            'suggest_json_editor': (bool, type(None)),  # noqa: E501
            'merge_variables': (dict, type(None)),  # noqa: E501
    ...
    attribute_map = {
        ...
        'suggest_json_editor': 'suggest_json_editor',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, html, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            engine (EngineHtml, type(None)): [optional] # noqa: E501
            suggest_json_editor (bool, type(None)): Used by frontend, true if the template uses advanced features. . [optional] # noqa: E501
            merge_variables (dict, type(None)): Used by frontend, an object representing the keys of every merge variable present in the template. It has one key named 'keys', and its value is an array of strings. . [optional] # noqa: E501
            ...
            object (str, type(None)): Value is resource type.. [optional] if omitted the server will use the default value of "version" # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, html, *args, **kwargs):  # noqa: E501
        """TemplateVersion - a model defined in OpenAPI
