...
class MultipleComponentsIntl(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, primary_line, country, *args, **kwargs):  # noqa: E501
        """MultipleComponentsIntl - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, primary_line, country, *args, **kwargs):  # noqa: E501
        """MultipleComponentsIntl - a model defined in OpenAPI
