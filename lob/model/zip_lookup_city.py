...
class ZipLookupCity(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, city, state, county, county_fips, preferred, *args, **kwargs):  # noqa: E501
        """ZipLookupCity - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, city, state, county, county_fips, preferred, *args, **kwargs):  # noqa: E501
        """ZipLookupCity - a model defined in OpenAPI
