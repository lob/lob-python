...
class TestReverseGeocodeLookupsApi(unittest.TestCase):
    ...
    def test_lookup_200(self):
        """Test case for lookup with status code 200"""        
    ...
    def test_lookup_0(self):
        """Test case for lookup with status code 0"""        
            ...
            with self.assertRaises(Exception) as context:
                self.api.(""""some invalid thing""")
            self.assertTrue("<SOME_ERROR_MSG>" in context.exception.__str__())

   
    
    def test_lookup_422(self):
        """Test case for lookup with status code 422"""        
