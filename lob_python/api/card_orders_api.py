...
class CardOrdersApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_endpoint = _Endpoint(
            settings={
                'response_type': (CardOrder,),
                'auth': [
                    'basicAuth'
                ],
                'endpoint_path': '/cards/{card_id}/orders',
                'operation_id': 'create',
                'http_method': 'POST',
                'servers': None,
            },
    ...
    def create(
        ...
        **kwargs
        ...
        Creates a new card order given information  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create(card_id, card_order_editable, async_req=True)
        >>> result = thread.get()
    ...
    def get(
        ...
        **kwargs
        ...
        Retrieves the card orders associated with the given card id.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
