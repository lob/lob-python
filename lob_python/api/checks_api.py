...
class ChecksApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.cancel_endpoint = _Endpoint(
            settings={
                'response_type': (CheckDeletion,),
                'auth': [
                    'basicAuth'
                ],
                'endpoint_path': '/checks/{chk_id}',
                'operation_id': 'cancel',
                'http_method': 'DELETE',
                'servers': None,
            },
    ...
    def cancel(
        ...
        **kwargs
        ...
        >>> thread = api.cancel(chk_id, async_req=True)
        >>> result = thread.get()
    ...
    def create(
        ...
        **kwargs
        ...
        Creates a new check with the provided properties.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create(check_editable, async_req=True)
        >>> result = thread.get()
    ...
    def get(
        ...
        **kwargs
        ...
        Retrieves the details of an existing check. You need only supply the unique check identifier that was returned upon check creation.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get(chk_id, async_req=True)
        >>> result = thread.get()
    ...
    def list(
        ...
        **kwargs
        ...
        Returns a list of your checks. The checks are returned sorted by creation date, with the most recently created checks appearing first.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
