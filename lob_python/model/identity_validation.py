...
globals()['IdentityValidationId'] = IdentityValidationId
globals()['PrimaryLineUs'] = PrimaryLineUs
globals()['Recipient'] = Recipient
globals()['SecondaryLine'] = SecondaryLine
globals()['Urbanization'] = Urbanization


class IdentityValidation(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'score': (float, type(None)),  # noqa: E501
            'confidence': (str, type(None)),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """IdentityValidation - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            score (float, type(None)): A numerical score between 0 and 100 that represents the likelihood the provided name is associated with a physical address. . [optional] # noqa: E501
            confidence (str, type(None)): Indicates the likelihood the recipient name and address match based on our custom internal calculation. Possible values are: - `high` — Has a Lob confidence score greater than 70. - `medium` — Has a Lob confidence score between 40 and 70. - `low` — Has a Lob confidence score less than 40. - `\"\"` — No tracking data exists for this address. . [optional] # noqa: E501
            object (str, type(None)): Value is resource type.. [optional] if omitted the server will use the default value of "id_validation" # noqa: E501
        """
