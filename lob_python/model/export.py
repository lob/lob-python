...
class Export(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            's3_url': (str, type(None)),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, date_created, date_modified, deleted, state, type, upload_id, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            s3_url (str, type(None)): The URL for the generated export file.. [optional] # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, date_created, date_modified, deleted, state, type, upload_id, *args, **kwargs):  # noqa: E501
        """Export - a model defined in OpenAPI
