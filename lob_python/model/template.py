...
globals()['TemplateVersion'] = TemplateVersion
...
class Template(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'id': (str,),  # noqa: E501
            'versions': (list,),  # noqa: E501
            'published_version': (TemplateVersion,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, versions, published_version, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            object (str, type(None)): Value is resource type.. [optional] if omitted the server will use the default value of "template" # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, versions, published_version, *args, **kwargs):  # noqa: E501
        """Template - a model defined in OpenAPI

        Args:
            id (TmplId):
            versions ([TemplateVersion]): An array of all non-deleted [version objects](#tag/Template-Versions) associated with the template.
            published_version (TemplateVersion):
