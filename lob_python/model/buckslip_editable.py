...
class BuckslipEditable(ModelNormal):
    ...
    def _from_openapi_data(cls, front, *args, **kwargs):  # noqa: E501
        """BuckslipEditable - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            back (str, type(None)): A PDF template for the back of the buckslip. [optional] # noqa: E501
