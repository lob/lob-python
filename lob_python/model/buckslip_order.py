...
class BuckslipOrder(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'buckslip_id': (str, type(None)),  # noqa: E501
    ...
    attribute_map = {
        ...
        'id': 'id',  # noqa: E501
        'buckslip_id': 'buckslip_id',  # noqa: E501
    ...
    def _from_openapi_data(cls, date_created, date_modified, object, *args, **kwargs):  # noqa: E501
        """BuckslipOrder - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            buckslip_id (str, type(None)): [optional] # noqa: E501
            status (str, type(None)): The status of the buckslip order.. [optional] # noqa: E501
            quantity_ordered (float, type(None)): The quantity of buckslips ordered.. [optional] if omitted the server will use the default value of 0 # noqa: E501
            unit_price (float, type(None)): The unit price for the buckslip order.. [optional] if omitted the server will use the default value of 0 # noqa: E501
            inventory (float, type(None)): The inventory of the buckslip order.. [optional] if omitted the server will use the default value of 0 # noqa: E501
            ...
            expected_availability_date (datetime, type(None)): The fixed deadline for the buckslips to be printed.. [optional] # noqa: E501
        """
