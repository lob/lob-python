...
class Upload(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, account_id, campaign_id, column_mapping, mode, state, total_mailpieces, failed_mailpieces, validated_mailpieces, bytes_processed, date_created, date_modified, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            campaign_id (str):
            column_mapping (dict): The mapping of column headers in your file to Lob-required fields for the resource created. See our <a href=\"https://help.lob.com/best-practices/campaign-audience-guide\" target=\"_blank\">Campaign Audience Guide</a> for additional details.
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, account_id, campaign_id, column_mapping, mode, state, total_mailpieces, failed_mailpieces, validated_mailpieces, bytes_processed, date_created, date_modified, *args, **kwargs):  # noqa: E501
        """Upload - a model defined in OpenAPI
