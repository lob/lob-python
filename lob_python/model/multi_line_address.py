...
class MultiLineAddress(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, primary_line, *args, **kwargs):  # noqa: E501
        """MultiLineAddress - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            state (str, type(None)): The <a href=\"https://en.wikipedia.org/wiki/ISO_3166-2:US\" target=\"_blank\">ISO 3166-2</a> two letter code or subdivision name for the state. `city` and `state` are required if no `zip_code` is passed.. [optional] # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, primary_line, *args, **kwargs):  # noqa: E501
        """MultiLineAddress - a model defined in OpenAPI
