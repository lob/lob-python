...
globals()['BgDescription'] = BgDescription
globals()['BgId'] = BgId
globals()['Name'] = Name


class BillingGroup(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, id, date_created, date_modified, *args, **kwargs):  # noqa: E501
        """BillingGroup - a model defined in OpenAPI
        ...
        Keyword Args:
            object (str): Value is resource type.. defaults to "billing_group", must be one of ["billing_group", ]  # noqa: E501
        ...
        object = kwargs.get('object', "billing_group")
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, id, date_created, date_modified, *args, **kwargs):  # noqa: E501
        """BillingGroup - a model defined in OpenAPI
