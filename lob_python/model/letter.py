...
class Letter(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'tracking_number': (str, type(None)),  # noqa: E501
            'tracking_events': (list, type(None)),  # noqa: E501
            'return_address': (str, AddressEditable, type(None)),  # noqa: E501
            'mail_type': (MailType, type(None)),  # noqa: E501
            'color': (bool, type(None)),  # noqa: E501
