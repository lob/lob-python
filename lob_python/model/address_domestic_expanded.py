...
class AddressDomesticExpanded(ModelNormal):
    ...
    validations = {
        ...
        ('address_country',): {
            'regex': {
                'pattern': r'UNITED STATES',  # noqa: E501
            },
        },
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """AddressDomesticExpanded - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            address_line1 (str, type(None)): The building number, street name, street suffix, and any street directionals. For US addresses, the max length is 64 characters.. [optional] # noqa: E501
            address_line2 (str, type(None)): The suite or apartment number of the recipient address, if applicable. For US addresses, the max length is 64 characters.. [optional] # noqa: E501
            address_city (str, type(None)): [optional] # noqa: E501
            address_state (str, type(None)): [optional] # noqa: E501
            address_zip (str, type(None)): Optional postal code. For US addresses, must be either 5 or 9 digits.. [optional] # noqa: E501
            description (str, type(None)): [optional] # noqa: E501
            name (str, type(None)): Either `name` or `company` is required, you may also add both. Must be no longer than 40 characters. If both `name` and `company` are provided, they will be printed on two separate lines above the rest of the address. . [optional] # noqa: E501
            ...
            address_country (str, type(None)): The country associated with this address.. [optional] # noqa: E501
