...
class IntlVerificationOrError(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """IntlVerificationOrError - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            country (str, type(None)): [optional] # noqa: E501
            coverage (str, type(None)): [optional] # noqa: E501
            ...
            object (str, type(None)): [optional] if omitted the server will use the default value of "intl_verification" # noqa: E501
