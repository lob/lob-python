...
class PostcardEditable(ModelNormal):
    ...
    def _from_openapi_data(cls, to, front, back, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            _from (str, AddressEditable, type(None)): Required if `to` address is international. Must either be an address ID or an inline object with correct address parameters.. [optional]  # noqa: E501
