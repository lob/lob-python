...
class Address(ModelComposed):
    ...
    def openapi_types():
        ...
        return {
            ...
            'address_country': (str, type(None)),  # noqa: E501
            ...
            'inline': (bool, type(None)),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            id (str): defaults to   # noqa: E501
            description (str): defaults to   # noqa: E501
            name (str): name associated with address. defaults to   # noqa: E501
            company (str): defaults to   # noqa: E501
            phone (str): Must be no longer than 40 characters.. defaults to   # noqa: E501
            email (str): Must be no longer than 100 characters.. defaults to   # noqa: E501
            metadata (MetadataModel): defaults to   # noqa: E501
            address_line1 (str): defaults to   # noqa: E501
            address_line2 (str): defaults to   # noqa: E501
            address_city (str): defaults to   # noqa: E501
            address_state (str): 2 letter state short-name code. defaults to   # noqa: E501
            address_zip (str): Must follow the ZIP format of `12345` or ZIP+4 format of `12345-1234`. . defaults to   # noqa: E501
            address_country (str): Full name of country. defaults to "UNITED STATES", must be one of ["UNITED STATES", ]  # noqa: E501
            object (str): defaults to "address", must be one of ["address", ]  # noqa: E501
            date_created (datetime): A timestamp in ISO 8601 format of the date the resource was created.. defaults to   # noqa: E501
            date_modified (datetime): A timestamp in ISO 8601 format of the date the resource was last modified.. defaults to   # noqa: E501
            deleted (bool): Only returned if the resource has been successfully deleted.. defaults to   # noqa: E501
            inline (bool): Checks if address id is used or not. defaults to   # noqa: E501
            recipient_moved (bool): Only returned for accounts on certain <a href=\"https://dashboard.lob.com/#/settings/editions\">Print &amp; Mail Editions</a>. Value is `true` if the address was altered because the recipient filed for a <a href=\"#ncoa\">National Change of Address (NCOA)</a>, `false` if the NCOA check was run but no altered address was found, and `null` if the NCOA check was not run. The NCOA check does not happen for non-US addresses, for non-deliverable US addresses, or for addresses created before the NCOA feature was added to your account. . defaults to   # noqa: E501
        """
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            address_country (str, type(None)): Full name of country. [optional] if omitted the server will use the default value of "UNITED STATES" # noqa: E501
            ...
            inline (bool, type(None)): Checks if address id is used or not. [optional] # noqa: E501
