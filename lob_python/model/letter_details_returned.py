...
globals()['CustomEnvelopeReturned'] = CustomEnvelopeReturned
globals()['MailType'] = MailType


class LetterDetailsReturned(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'cards': (list,),  # noqa: E501
            'address_placement': (str, type(None)),  # noqa: E501
            'custom_envelope': (CustomEnvelopeReturned, type(None)),  # noqa: E501
    ...
    attribute_map = {
        ...
        'bleed': 'bleed',  # noqa: E501
        'file_original_url': 'file_original_url',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, color, cards, *args, **kwargs):  # noqa: E501
        """LetterDetailsReturned - a model defined in OpenAPI

        Args:
            color (bool): Set this key to `true` if you would like to print in color, false for black and white.
            cards (list): A single-element array containing an existing card id in a string format. See [cards](#tag/Cards) for more information.
        ...
        Keyword Args:
            ...
            custom_envelope (CustomEnvelopeReturned, type(None)): [optional] # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, color, cards, *args, **kwargs):  # noqa: E501
        """LetterDetailsReturned - a model defined in OpenAPI

        Args:
            color (bool): Set this key to `true` if you would like to print in color, false for black and white.
            cards ([CardId], none_type): A single-element array containing an existing card id in a string format. See [cards](#tag/Cards) for more information.
