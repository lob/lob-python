...
class UploadFile(ModelNormal):
    ...
    def _from_openapi_data(cls, filename, *args, **kwargs):  # noqa: E501
        """UploadFile - a model defined in OpenAPI

        Args:
            filename (str):

        Keyword Args:
            message (str): defaults to "File uploaded successfully", must be one of ["File uploaded successfully", ]  # noqa: E501
        ...
        message = kwargs.get('message', "File uploaded successfully")
