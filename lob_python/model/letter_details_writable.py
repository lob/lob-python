...
globals()['CustomEnvelopeUserProvided'] = CustomEnvelopeUserProvided
globals()['MailType'] = MailType


class LetterDetailsWritable(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, cards, color, *args, **kwargs):  # noqa: E501
        """LetterDetailsWritable - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            return_envelope (bool, type(None)): [optional] if omitted the server will use the default value of False # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, cards, color, *args, **kwargs):  # noqa: E501
        """LetterDetailsWritable - a model defined in OpenAPI
