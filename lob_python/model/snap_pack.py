...
globals()['SnapPackSize'] = SnapPackSize
globals()['SnpId'] = SnpId
globals()['SnpUseType'] = SnpUseType
globals()['TrackingEventCertified'] = TrackingEventCertified


class SnapPack(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'url': (str,),  # noqa: E501
            'use_type': (SnpUseType,),  # noqa: E501
            '_from': (str, AddressDomesticExpanded, type(None)),  # noqa: E501
            'size': (SnapPackSize, type(None)),  # noqa: E501
            ...
            'outside_template_id': (str, type(None)),  # noqa: E501
            'inside_template_id': (str, type(None)),  # noqa: E501
            'outside_template_version_id': (str, type(None)),  # noqa: E501
            'inside_template_version_id': (str, type(None)),  # noqa: E501
    ...
    attribute_map = {
        ...
        'outside_template_id': 'outside_template_id',  # noqa: E501
        'inside_template_id': 'inside_template_id',  # noqa: E501
        'outside_template_version_id': 'outside_template_version_id',  # noqa: E501
        'inside_template_version_id': 'inside_template_version_id',  # noqa: E501
    ...
    def _from_openapi_data(cls, id, to, url, use_type, *args, **kwargs):  # noqa: E501
        """SnapPack - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            _from (str, AddressDomesticExpanded, type(None)): [optional]  # noqa: E501
            size (SnapPackSize, type(None)): [optional] # noqa: E501
            ...
            outside_template_id (str, type(None)): The unique ID of the HTML template used for the outside of the snap pack.. [optional] # noqa: E501
            inside_template_id (str, type(None)): The unique ID of the HTML template used for the inside of the snap pack.. [optional] # noqa: E501
            outside_template_version_id (str, type(None)): The unique ID of the specific version of the HTML template used for the outside of the snap pack.. [optional] # noqa: E501
            inside_template_version_id (str, type(None)): The unique ID of the specific version of the HTML template used for the inside of the snap pack.. [optional] # noqa: E501
            object (str, type(None)): Value is resource type.. [optional] if omitted the server will use the default value of "snap_pack" # noqa: E501
            tracking_events (list, type(None)): An array of certified tracking events ordered by ascending `time`. Not populated in test mode.. [optional] # noqa: E501
        """
